import { Component, Inject, NgZone, PLATFORM_ID, EventEmitter, Input, Output, OnChanges } from '@angular/core';
...
export class MapComponent {
    ...
    ngAfterViewInit() {
      ...
      this.browserOnly(() => {
        ...
        hs.properties.fill = am4core.color("#275d6f");
        ...
        polygonTemplate.events.on("hit", function(ev) {
          this.clickMap(ev.target.dataItem.dataContext['id'])
        }, this);
